...
import { ARCHITECTURE_DATA, AUTH_SNIPPETS, CONFIG_SNIPPETS, COURSE_SNIPPETS, USER_SNIPPETS, EXPORT_SNIPPETS, TESTING_SNIPPETS, DATABASE_STRATEGY } from '../constants';
          ...
          <div className="bg-slate-900 rounded-xl shadow-lg border border-slate-700 overflow-hidden flex flex-col animate-fadeIn">
                <div className="bg-slate-800 px-4 py-3 border-b border-slate-700 flex justify-between items-center">
                    <h3 className="font-bold text-white text-sm flex items-center gap-2">
                        ...
                        Estrategia de Base de Datos & Indexación (Futuro)
                    </h3>
                </div>
