        ...
        return (
            <div className="animate-fadeIn space-y-6">
                 <div className="flex justify-between items-center">
                    ...
                    {(isAdmin || isAdvisor) && (
                        <button id="tour-genact-btn-create" onClick={() => {
                            setFormData({
