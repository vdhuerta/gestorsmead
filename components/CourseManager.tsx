                                  ...
                                  <form onSubmit={handleEnrollSubmit} className="space-y-6">
                                      ...
                                      {isAlreadyEnrolled ? (
                                          ...
                                          <button 
                                              type="submit" 
                                              disabled={isSyncing} 
                                              className={`w-full bg-[#647FBC] hover:bg-blue-800 text-white px-4 py-3 rounded-lg text-sm font-bold shadow transition-colors mt-4 ${isSyncing ? 'opacity-70 cursor-wait' : ''}`}
                                          >
