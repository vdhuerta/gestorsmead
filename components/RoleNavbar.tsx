...
const NAV_ITEMS: NavItem[] = [
  ...
  { 
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" title="Configuración Global">
  ...
  { 
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" title="Modelo Entidad-Relación">
  ...
  { 
    ...
    allowedRoles: [UserRole.ADMIN],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" title="Arquitectura Técnica">
